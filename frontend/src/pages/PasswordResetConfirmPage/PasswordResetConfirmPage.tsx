...
interface ParsedResetKey {
  uid: string;
  token: string;
}

function parseResetKey(key: string): ParsedResetKey | null {
...
export default function PasswordResetConfirmPage(): React.ReactElement {
  const { key = '' } = useParams();
          ...
          fields={[
            {
              ...
              value: password1,
              onChange: (v) => setPassword1(v as string),
              required: true,
            },
            {
              name: 'new_password2',
              ...
              autoComplete: 'new-password',
              value: password2,
              onChange: (v) => setPassword2(v as string),
              required: true,
            },
          ]}
